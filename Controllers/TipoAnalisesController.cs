...
namespace ProjetoLaboratorio.Controllers
{
    public class TipoAnalisesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TipoId,TipoAnalise,valor")] TipoAnalisesModel tipoAnalisesModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TipoId,TipoAnalise,valor")] TipoAnalisesModel tipoAnalisesModel)
        {
