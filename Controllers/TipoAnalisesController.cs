...
namespace ProjetoLaboratorio.Controllers
{
    public class TipoAnalisesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TipoId,Descricao,valor")] TipoAnalisesModel tipoAnalisesModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TipoId,Descricao,valor")] TipoAnalisesModel tipoAnalisesModel)
        {
